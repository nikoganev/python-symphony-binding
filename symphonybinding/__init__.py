...
class SymCodegen():
    ...
    def __init__(self):
        self.agent_swagger = pkg_resources.resource_filename('agent-api-public-deprecated.yaml')
        self.pod_swagger = pkg_resources.resource_filename('pod-api-public-deprecated.yaml')
